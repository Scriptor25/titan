...
titan::result<std::vector<VkSurfaceFormat2KHR>> titan::vk::GetPhysicalDeviceSurfaceFormats2KHR(
...
titan::result<std::vector<VkPresentModeKHR>> titan::vk::GetPhysicalDeviceSurfacePresentModesKHR(
    VkPhysicalDevice physical_device,
...
titan::result<std::vector<VkImage>> titan::vk::GetSwapchainImagesKHR(
    VkDevice device,
...
titan::result<> titan::vk::BindBufferMemory2(VkDevice device, const VkBindBufferMemoryInfo &bind_info)
{
...
titan::result<> titan::vk::BindBufferMemory2(VkDevice device, const std::vector<VkBindBufferMemoryInfo> &bind_infos)
{
...
titan::result<> titan::vk::BindImageMemory2(VkDevice device, const VkBindImageMemoryInfo &bind_info)
{
...
titan::result<> titan::vk::BindImageMemory2(VkDevice device, const std::vector<VkBindImageMemoryInfo> &bind_infos)
{
...
titan::result<std::vector<char>> titan::vk::GetPipelineCacheData(VkDevice device, VkPipelineCache pipeline_cache)
{
    size_t data_size;
...
titan::result<> titan::vk::ResetCommandBuffer(VkCommandBuffer command_buffer, VkCommandBufferResetFlags flags)
{
...
titan::result<> titan::vk::BeginCommandBuffer(VkCommandBuffer command_buffer, const VkCommandBufferBeginInfo &begin_info)
{
...
titan::result<> titan::vk::EndCommandBuffer(VkCommandBuffer command_buffer)
{
...
titan::result<void *> titan::vk::MapMemory2(VkDevice device, const VkMemoryMapInfo &map_info)
{
    void *data;
...
titan::result<> titan::vk::UnmapMemory2(VkDevice device, const VkMemoryUnmapInfo &unmap_info)
{
...
titan::result<VkSurfaceCapabilities2KHR> titan::vk::GetPhysicalDeviceSurfaceCapabilities2KHR(
    VkPhysicalDevice physical_device,
    const VkPhysicalDeviceSurfaceInfo2KHR &surface_info)
{
